...
// Operand : The variables or values on which the operation is performed
...
// Division : /
val quotient = 20 / 6 // The result will be an Int, because both the operands are Int, the result will be rounded off to the floor value
